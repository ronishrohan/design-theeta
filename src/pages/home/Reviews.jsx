...
const Reviews = () => {
  ...
  return (
    <section className="py-28 px-6 md:px-12 bg-stone-950 select-none">
      <motion.h2
      ...
      <div className="flex justify-center items-center gap-8 pt-12 max-w-3xl mx-auto relative">
        <div
          className="w-full max-w-xl min-h-[340px] flex items-center justify-center relative"
          style={{ height: 360 }}
        >
          {testimonials.map((t, i) => {
            ...
            return (
              <motion.div
                ...
                initial={false}
                exit={false}
                className="absolute left-0 right-0 mx-auto bg-stone-900 border border-stone-800/60 rounded-lg shadow-xl p-10 flex flex-col items-center text-center w-full cursor-pointer"
                style={{
